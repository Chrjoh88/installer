...
script may disrupt mailman use this
useradd -c "mailman" -s /no/shell -d /no/home -g list list

Install
curl and wget to be sure scripts running fine
----
...
Download the script using `git clone https://github.com/Chrjoh88/installer.git`. + 
